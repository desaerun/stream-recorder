...
import com.desaerun.ffmpeg.progress.ProgressParser;
import com.desaerun.ffmpeg.progress.TcpProgressParser;
...
public class FFmpeg extends FFcommon {
  ...
  public Process run(FFmpegBuilder builder) throws IOException {
    return run(builder, null);
  }

  public Process run(FFmpegBuilder builder, @Nullable ProgressListener listener) throws IOException {
