...
public class FFmpegOutputBuilder extends AbstractFFmpegStreamBuilder<FFmpegOutputBuilder> {
   ...
   *
   * @param bit_depth The sample format, one of the com.desaerun.ffmpeg.FFmpeg#AUDIO_DEPTH_* constants.
   * @return this
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_DEPTH_U8
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_DEPTH_S16
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_DEPTH_S32
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_DEPTH_FLT
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_DEPTH_DBL
   ...
   *
   * @param sample_format The sample format, one of the com.desaerun.ffmpeg.FFmpeg#AUDIO_FORMAT_*
   *     constants.
   * @return this
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_FORMAT_U8
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_FORMAT_S16
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_FORMAT_S32
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_FORMAT_FLT
   * @see com.desaerun.ffmpeg.FFmpeg#AUDIO_FORMAT_DBL
   */
